...
public final class StrinovaKeyBindings {
    ...
    private static void onClientTick(Minecraft client) {
        ...
        boolean ctrlDown = client.screen == null && stringifyKey != null
                && (stringifyKey.isDown() || InputConstants.isKeyDown(client.getWindow().getWindow(), GLFW.GLFW_KEY_LEFT_CONTROL));
