...
import com.hhdxcz.wa.mixin.client.PoseStackAccessor;
import com.mojang.blaze3d.vertex.PoseStack;

import java.util.Deque;

public final class WaRenderPoseLeakGuard {
    ...
    public static void drain(PoseStack poseStack) {
        ...
        try {
            ...
            WaMod.LOGGER.error("Failed to drain leaked PoseStack pushes", e);
        } finally {
            LEAK_PUSH_COUNT.set(0);
            LAST_STACK.set(null);
        }
